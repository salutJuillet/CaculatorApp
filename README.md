...
# Calculator App
    ...
    [![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=salutJuillet&layout=compact)](https://github.com/salutJuillet/CalculatorApp)
-->
...
1. Clone the repo
   ```sh
   git clone https://github.com/salutJuillet/CalculatorApp.git
   ```
2. 
<br/>
